...
public class LeaderboardBean implements Serializable, Comparable<LeaderboardBean> {
    ...
    public LeaderboardBean(String studentId, String username, String password, String firstName, String lastName, int pointsToAward, String department, String story, String position, boolean admin, String location, String imageBytes,List<RewardRecords> recordsArrList) {
    ...
    @Override
    public int compareTo(LeaderboardBean o) {
