...
public class CreateProfileAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public CreateProfileAsyncTask(CreateActivity createActivity, CreateProfileBean bean) {
    ...
    protected void onPostExecute(String connectionResult) {
        ...
        if (code == HTTP_OK) {
            try {
                ...
                bean = new CreateProfileBean("A20374655", username, password, firstName, lastName, pointsToAward, department, story, position, admin, location, imageBytes);
